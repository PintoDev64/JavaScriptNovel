...
function Parser(ListTokens) {
    ...
    function TokenReader() {
        ...
        if (actualToken.type === "string") {
            ...
            if (cursorPosition < ListTokens.length && ListTokens[cursorPosition].type === "colon" && ListTokens[cursorPosition].value === constants_1.COLON) {
                cursorPosition++;
                AstString.content = [];
                while (cursorPosition < ListTokens.length && !(ListTokens[cursorPosition].type === "keys" && ListTokens[cursorPosition].value === constants_1.CLOSE_KEY)) {
                    cursorPosition++;
                    AstString.content?.push(TokenReader());
                }
                if (cursorPosition < ListTokens.length && ListTokens[cursorPosition].type === "keys" && ListTokens[cursorPosition].value === constants_1.CLOSE_KEY) {
                    cursorPosition++;
        ...
        if (actualToken.type === "name") {
            ...
            if (cursorPosition < ListTokens.length && ListTokens[cursorPosition].type === "parenthesis" && ListTokens[cursorPosition].value === constants_1.OPEN_PARENTHESIS) {
                cursorPosition++;
                const AstParams = {
                    type: "CallExpression",
                    name: AstParse.name,
                ...
                while (cursorPosition < ListTokens.length && !(ListTokens[cursorPosition].type === "parenthesis" && ListTokens[cursorPosition].value === constants_1.CLOSE_PARENTHESIS)) {
                ...
                if (cursorPosition < ListTokens.length && ListTokens[cursorPosition].type === "parenthesis" && ListTokens[cursorPosition].value === constants_1.CLOSE_PARENTHESIS) {
                    cursorPosition++;
                    actualToken = ListTokens[cursorPosition];
                }
                else {
                ...
                if (cursorPosition < ListTokens.length && ListTokens[cursorPosition].type === "keys" && ListTokens[cursorPosition].value === constants_1.OPEN_KEY) {
                    AstParams.content = [];
